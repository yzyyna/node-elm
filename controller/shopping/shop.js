...
class Shop extends AddressComponent {
	...
	async getRestaurants(req, res, next) {
		console.log(`lp:server /shopping/restaurants/`, req.query)
		const {
			latitude,
			longitude,
			offset = 0,
		...
		// 20220107周五14:20:43lpeng：此处测试更新所有的shop的图片儿
		// restaurants.map(item => {
		// 	// ShopModel.find({"id":item._doc.id},function(err,doc){
		// 	// 	console.log(doc)
		// 	// })
		// 	ShopModel.update({
		// 		"id": item._doc.id
		// 	}, {
		// 		$set: {
		// 			image_path: '17c8e1607de100594.jpg'
		// 		}
		// 	}, function (err, doc) {
	...
	async getRestaurantDetail(req, res, next) {
		console.log(`lp server /shopping/restaurant/:id`,req.params)
